...
var I18N = {
  ...
  en: {
    ...
    'audit.lead':"A summary of your systems: what works, what could be better and what needs fixing first. Here is what it looks like.",
    'audit.sample':"Illustrative example · systems and figures invented",
    'audit.title':"Systems summary",
    'audit.disclosure':"This is the first page of the report. It shows the format, not somebody's audit: the system names and numbers here are made up.",
    'audit.act':"needs action",
    'audit.warn':"worth improving",
    'audit.ok':"looks fine",
    'audit.f1n':"Database · backups",
    'audit.f1d':"The jobs succeed, but recovery has never been tested. Until a copy is restored in a separate environment, how long it takes and how much data comes back are unknown.",
    'audit.f2n':"Incident response",
    'audit.f2d':"There is no procedure: who picks up at night, who gets called next, what gets written down afterwards. Every outage is worked out from scratch.",
    'audit.f3n':"Alerting",
    'audit.f3d':"Metrics are collected, but alerts reach nobody: users report the outage first. This needs a delivery route and proof that it works.",
    'audit.f4n':"Cloud spend",
    'audit.f4d':"Three idle nodes, two years of snapshots and reserved capacity nobody uses. In this example that is roughly $3,000 a month going nowhere.",
    'audit.f5n':"API response time",
    'audit.f5d':"One endpoint is slow and drags the whole load profile with it. The cause is in the queries, not in the size of the server.",
    'audit.f6n':"CI/CD and deployment",
    'audit.f6d':"Builds finish in a few minutes, rollback is documented and tested. Nothing to change here.",
    'audit.f7n':"Access and secrets",
    'audit.f7d':"No keys in the repository, access is granted per task. No findings on this one.",
    'audit.tally':"Total: 3 need action · 2 worth improving · 2 look fine.",
    'audit.nexth':"What I propose doing",
    'audit.nextd':"The three items marked \u201cneeds action\u201d plus the cloud spend — about five days of work. Acceptance: recovery tested and its time recorded, alerts reaching the person on call, and the cloud bill lower by the agreed amount.",
    'audit.est':"5 days · $3,000",
    'audit.estd':"— in this example the cloud saving pays the work back in 28 days.",
    'audit.pricenote':"I quote your work after the diagnosis: it depends on the number of systems, the access involved and how complex the changes are. If I couldn\u2019t help, you pay nothing.",
