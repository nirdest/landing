...
var I18N = {
  ...
  en: {
    ...
    'hero.ai':'AI prototypes → production:',
    ...
    'cmp.eyebrow':'diff before after','cmp.h':'The same night. Two infrastructures.',
    ...
    'cmp.c4t':'I deal with it, not you','cmp.c4d':'Metrics and alerts across the whole chain, wired so that I hear about a problem first. It reaches you with a fix attached — or it never reaches you at all.',

    'avoid.eyebrow':'cat boundaries.txt','avoid.h':'What I won’t do',
    ...
    'svc.eyebrow':'services --list','svc.h':'What exactly I take on',
    ...
    'prc.eyebrow':'how-i-work --steps','prc.h':'Four steps, and the first one is free',
    ...
    'prc.5n':'after','prc.5t':'Then — whatever suits you','prc.5d':'We can close the job and part ways: the system stays yours and your team runs it. Or you leave the infrastructure with me on a monthly basis — and stop dealing with administration entirely.',

    'exp.eyebrow':'whoami','exp.h':'Why you can trust me with production',
    ...
    'alt.eyebrow':'compare --alternatives','alt.h':'What you’re actually comparing this to',
    ...
    'faq.eyebrow':'man faq','faq.h':'Frequently asked',
    ...
    'cta.eyebrow':'./start.sh','cta.h':'Let’s start with the free diagnosis',
