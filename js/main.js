...
var I18N = {
  ru: {
    ...
    'cmp.eyebrow':'02 — Что меняется','cmp.h':'Было и стало',
    ...
    'avoid.eyebrow':'03 — Границы','avoid.h':'Чего я не делаю',
    ...
    'svc.eyebrow':'01 — Услуги','svc.h':'Что именно я делаю',
    ...
    'exp.lead':'Десять лет в IT, шесть из них — в DevOps и production engineering. Работаю и с облаком, и с железом: от небольших SaaS до систем, где простой считают в деньгах.',
    'exp.n1':'лет в IT','exp.n2':'лет в DevOps','exp.n3':'за диагностику',
    'exp.s1k':'Оркестрация','exp.s1v':'Kubernetes · Amazon EKS · Docker · Helm',
    'exp.s2k':'Облако и железо','exp.s2v':'AWS · GCP · OpenStack · bare metal',
    'exp.s3k':'Инфраструктура как код','exp.s3v':'Terraform · Ansible',
    'exp.s4k':'GitOps и CI/CD','exp.s4v':'ArgoCD · GitLab CI · GitHub Actions · Jenkins',
    'exp.s5k':'Наблюдаемость','exp.s5v':'Prometheus · Grafana · Loki · OpenTelemetry',
    'exp.s6k':'Секреты и доступы','exp.s6v':'Vault · External Secrets · Keycloak · SSO',
    'exp.s7k':'Данные и очереди','exp.s7v':'PostgreSQL · Redis · Dragonfly · Kafka',
    'exp.s8k':'Сеть и доставка','exp.s8v':'Cloudflare · NGINX · HAProxy · CDN',
    'exp.s9k':'Хранилища','exp.s9v':'Ceph · MinIO · Amazon S3',
